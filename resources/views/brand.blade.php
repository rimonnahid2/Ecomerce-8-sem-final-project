...
@section('content')
    ...
    <div class="home">
        <div class="home_background parallax-window" data-parallax="scroll" data-image-src="{{ asset('storage/app/public/'.$brand->image) }}"></div>
        <div class="home_overlay"></div>
        <div class="home_content d-flex flex-column align-items-center justify-content-center">
            <h2 class="home_title">All {{ $brand->brand_name }}'s Product</h2>
        </div>
    </div>
    <!-- Shop -->
                    ...
                    <div class="shop_content">
                        ...
                        <div class="product_grid">
                            ...
                            <div class="product_item is_new">
                                ...
                                <a href="{{ $data->path() }}" class="text-dark" tabindex="0">
                                ...
                                <div class="product_content">
                                    ...
                                    <div class="product_name"><div>{{ $data->name }}</div></div>
                                </div>
                                </a>
