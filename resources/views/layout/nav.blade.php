        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Categories</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Sub-Category</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Brands</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Coupon</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Post</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
