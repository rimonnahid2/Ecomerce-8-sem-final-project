                ...
                <div class="ibox-content">
                    <form action="{{ url('/admin/post/update/'.$post->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Post Title</label>
                            ...
                            <div class="col-sm-10"><input type="text" name="title" class="form-control" value="{{ $post->title }}"><span class="form-text m-b-none">Enter a valid category name..</span></div> 
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Post tile (বাংলা)</label>
                            ...
                            <div class="col-sm-10"><input type="text" name="title_bn" class="form-control" value="{{ $post->title_bn }}"><span class="form-text m-b-none">Enter a valid category name..</span></div>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Post Category</label>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="postcategory_id">
                                    ...
                                    <option value="{{ $cate->id }}" {{ $cate->id == $post->postcategory_id ? 'selected' : ''}}>{{ $cate->cate_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Post description</label>
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" id="summary-ckeditor"> {{ $post->description }}</textarea>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Post description (বাংলা)</label>
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description_bn" id="summary-ckeditor1"> {{ $post->description_bn }}</textarea>
