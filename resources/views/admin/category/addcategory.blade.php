        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="{{ URL::to('/admin/category/add_category') }}" method="POST" enctype="multipart/form-data">
                    	@csrf
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <tr class="gradeX">
                    ...
                    <td>
                        @if($data->image)
                        <img src="{{ asset('storage/app/public/'.$data->image) }}" height="30px" width="40px">
                        @endif
                    </td>
                    <td>{{ $data->created_at }}</td>
                    <td>
                        <a href="{{ url('/admin/category/editcategory/'.$data->id) }}" class="btn btn-success btn-xs">Edit</a>
                        <a href="{{ url('/admin/category/delete/'.$data->id) }}" class="btn btn-danger btn-xs" id="delete">Delete</a>
                    </td>
                </tr>
                @endforeach
                </tbody>
